...
average.sts.k <- get_average_stabilities_per_k(existing.dataset.analysis)
...
# Extract results
pa.scores <- get_partition_agreement_scores(agreement.results)
```
...
# Plot results
get_top30percent_coefficients(signature.results)
```
